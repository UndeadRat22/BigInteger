...
ErrorCode push_front(List*, char);                        /* push entry at the front of list in O(1) time */
ErrorCode push_back(List*, char);                         /* push entry at the end of list in O(n) time */
...
ErrorCode insert(List*, int, char);                       /* insert entry by index [1, n] */
ErrorCode delete_by_index(List*, int);                    /* delete entry by index [1, n] */
